      ...
      {loading ? (
        ...
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl font-bold text-slate-800 dark:text-white flex items-center">
            <Archive className="w-6 h-6 mr-3 text-teal-500" /> Archival History
          </h2>
          <button className="flex items-center text-sm font-medium text-slate-500 hover:text-teal-600 bg-white border border-slate-200 px-3 py-1.5 rounded-md transition-colors shadow-sm">
                ...
                {filteredHistory.map((po) => (
                  <tr key={po.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <button className="text-teal-600 hover:text-teal-900 dark:text-teal-400 dark:hover:text-teal-300">View Details</button>
                    </td>
                  </tr>
                ))}
              </tbody>
